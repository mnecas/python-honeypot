...
def start_http_honeypot(ip='0.0.0.0'):
    try:
        # We create socket listener which we bind on our default adress
...
if __name__ == "__main__":
    # If we run this file by itself we assueme that the developer is running it
